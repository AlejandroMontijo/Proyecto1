...
public class PanelPacientes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelCampos.setLayout(new java.awt.GridLayout(3, 4, 5, 5));
        ...
        panelCampos.add(lblVacio1);
        panelCampos.add(lblVacio2);
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][] {},
                new String[] { "ID", "Nombre", "Edad", "Dirección", "Teléfono" }) {
        ...
        btnFiltrarDir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFiltrarDirActionPerformed(evt);
            }
        });
        panelFiltros.add(btnFiltrarDir);

        btnFiltrarEdad.setText("Por Edad");
        btnFiltrarEdad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFiltrarEdadActionPerformed(evt);
            }
        });
        panelFiltros.add(btnFiltrarEdad);

        btnFiltrarAmbos.setText("Ambos");
        btnFiltrarAmbos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFiltrarAmbosActionPerformed(evt);
            }
        });
    ...
    private void btnFiltrarDirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnFiltrarDirActionPerformed
        filtrarPorDireccion();
    }// GEN-LAST:event_btnFiltrarDirActionPerformed

    private void btnFiltrarEdadActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnFiltrarEdadActionPerformed
        filtrarPorEdad();
    }// GEN-LAST:event_btnFiltrarEdadActionPerformed

    private void btnFiltrarAmbosActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnFiltrarAmbosActionPerformed
        filtrarCombinado();
    }// GEN-LAST:event_btnFiltrarAmbosActionPerformed
    ...
    private void agregarPaciente() {
        ...
        Paciente p = new Paciente(0, nombre, edad, direccion, telefono);
    ...
    private void buscarPaciente() {
        ...
        try {
            ...
            Paciente p = fachada.buscarPaciente(id);
            if (p != null) {
    ...
    private void actualizarPaciente() {
        ...
        try {
            int id = Integer.parseInt(idStr);
            Paciente existente = fachada.buscarPaciente(id);
            if (existente == null) {
            ...
            if (resp == JOptionPane.YES_OPTION) {
                Paciente actualizado = new Paciente(id, nombre, edad, direccion, telefono);
    ...
    private void actualizarTabla(List<Paciente> lista) {
        ...
        for (Paciente p : lista) {
            modeloTabla.addRow(new Object[] {
                    p.getId(), p.getNombre(), p.getEdad(), p.getDireccion(), p.getTelefono()
            });
        }
    }
